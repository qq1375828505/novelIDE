...
```
网文写作IDE/
├── Android/          ← DAXIE666（Flutter 单机版，已发布 V1.4.0）
│   ├── 双编辑器（纯文本 + WebView富文本）
...
└── Android技术方案.md  ← Android版技术文档（V1.4.0）
```
...
| 版本 | 日期 | 说明 |
|------|------|------|
| V1.4.0 | 2026-05-26 | **UI重构**：仿作家助手交互流程（4Tab底部导航 · 作品首页 · 作品详情页 · 继续写作FAB）· 导出页折叠收缩 · 卡片样式全面升级 |
| V1.4.0 | 2026-05-26 | **大版本**：8种主题皮肤 · WebView富文本编辑器 · 跨章节全局搜索 · 文章校对引擎(60+词库) · EPUB电子书导出 · 编辑器9按钮快捷栏 · 快捷短语 · DOCX导入自动创建作品 |
| V1.4.0 | 2026-05-26 | 修复导出保存到本地失败、修复类作用域错误 |
| V1.4.0 | 2026-05-26 | TXT/MD/DOCX导入、AI智能分析填充资料库、导出全选/全不选 |
| V1.4.0 | 2026-05-26 | 修复章节内容丢失Bug、dispose强制保存 |
| V1.4.0 | 2026-05-26 | 运行时权限、卷长按菜单、全页面导出、19项权限 |
| V1.4.0 | 2026-05-25 | 多协议(OpenAI+Anthropic)、测试连接、JSON配置、上下文压缩 |
| V1.4.0 | 2026-05-25 | AI对话窗口(独立Tab)、导出系统重写、小说记忆系统 |
| V1.4.0 | 2026-05-25 | 写作统计图表、全文审查、多模型路由、AgentForge |
| V1.4.0 | 2026-05-25 | 资料管理扩展(8种)、大纲增强、番茄报告UI |
| V1.4.0 | 2026-05-24 | 基础框架、作品管理、编辑器、AI基础动作 |
